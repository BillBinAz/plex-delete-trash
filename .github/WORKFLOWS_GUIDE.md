...
This document explains all GitHub Actions workflows in the plex-delete-trash project and how to use them.
...
- **Image tag format:** `billbinaz/plex-delete-trash:pr-XX`, `billbinaz/plex-delete-trash:sha-XXXXX`
...
- **Tags:**
  - `ghcr.io/billbinaz/plex-delete-trash:v1.0.0`
  - `ghcr.io/billbinaz/plex-delete-trash:latest`
  - `billbinaz/plex-delete-trash:v1.0.0`
  - `billbinaz/plex-delete-trash:latest`
...
**Maintained by:** plex-delete-trash Team
